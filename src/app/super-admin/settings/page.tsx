        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden mt-6">
          <div className="p-6 border-b border-slate-800 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Update your account password to maintain security.</p>
            </div>
          </div>
          <div className="p-6">
            <PasswordChangeForm />
    ...
    <form onSubmit={handleSubmit} className="space-y-4 max-w-sm">
      ...
      <div>
        ...
        <input
          ...
          className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-amber-500/50 focus:ring-1 focus:ring-amber-500/50 text-sm"
          required
        />
      </div>
      <div>
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-slate-800 hover:bg-slate-700 text-white font-bold py-2.5 px-5 rounded-xl transition-colors disabled:opacity-50 mt-2 text-sm flex justify-center items-center gap-2"
      >
        Update Password
      </button>
    </form>
